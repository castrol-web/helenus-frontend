...
import { FaBars, FaTimes, FaHome, FaUserTie, FaFileAlt, FaCog } from "react-icons/fa";
...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            {/* Sidebar (desktop) */}
            <div className="hidden md:flex w-64 h-screen bg-base-200 p-4 shadow-md flex-col fixed left-0 top-0 z-40">
                ...
                {navItems.map((item) => (
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `flex items-center gap-3 p-2 mb-2 rounded transition ${
                                isActive ? "bg-primary text-white" : "hover:bg-base-300 text-slate-50"
                            }`
                        }
                    >
                        {item.icon}
